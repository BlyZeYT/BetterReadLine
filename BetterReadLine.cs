namespace BetterReadLine
{
    ...
    public class ConsoleInputReader
    {
        ...
        /// Console.ReadLine(); with input restriction
        /// </summary>
        /// <param name="validInputs">A <see cref="IEnumerable{string}"/> that contains <see cref="string"/> that contains all valid <see cref="char"/></param>
        /// <returns>Returns the input as <see cref="string"/></returns>
    ...
    /// </summary>
    public struct InputReaderColor
    {
        ...
        /// </summary>
        public Color BaseColor { get => _color; }

        /// <summary>
        /// Alpha value
        /// </summary>
        public byte A { get => _color.A; }

        /// <summary>
        /// Red Value
        /// </summary>
        public byte R { get => _color.R; }

        /// <summary>
        /// Green Value
        /// </summary>
        public byte G { get => _color.G; }

        /// <summary>
        /// Blue Value
        /// </summary>
        public byte B { get => _color.B; }
